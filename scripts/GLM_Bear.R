...
barplot(bearDataSum$nSeqs)
barplot(bearDataFall$nSeqs)
barplot(bearDataWin$nSeqs)
barplot(bearDataSpr$nSeqs)
...
summary(glm.nb.Slog) #This is likely the best model
