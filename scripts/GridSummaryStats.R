...
#_____________________________________________
##CapRates Point Size Figures- ALL SEASONS----
#_____________________________________________
#PRETTY SURE THIS IS ALL WRONG. CANNOT DO IT LIKE THIS. NEED TO START WITH ANOTHER FILE.
#NEED TO WRITE A CIRCLE PLOT FUNCTION
par(mar = c(1,1,1,1))
par(mfrow = c(2,3))
s<-22 #Sets point size modification to make graphs readable
#ALL SPECIES, ALL SEASONS
plot(camdata_summary$NAD83_X, camdata_summary$NAD83_Y, axes = F, 
     xlab = "", ylab = "",
...
box()
  points(camdata_summary$NAD83_X, camdata_summary$NAD83_Y,
       ...
       xlim = c(747430, 747550),
       ylim = c(4308910,4309030))
  text(labels = "All Species", y = 4309025, x = 747442, cex = 1.6)
...
camdata_summary %>%
  ...
  with(plot(NAD83_X, NAD83_Y,main = "", axes = F, 
            xlab = "", ylab = "",
            cex = CR/s, 
            pch = 20,
            xlim = c(747430, 747550),
...
box()
  points(camdata_summary$NAD83_X, camdata_summary$NAD83_Y,
       ...
       xlim = c(747430, 747550),
       ylim = c(4308910,4309030))
  text(labels = "White-tailed Deer", y = 4309025, x = 747449, cex = 1.6)
...
box()
  points(camdata_summary$NAD83_X, camdata_summary$NAD83_Y,
       ...
       xlim = c(747430, 747550),
       ylim = c(4308910,4309030))
  text(labels = "Gray Squirrel", y = 4309025, x = 747443, cex = 1.6)
...
box()
  points(camdata_summary$NAD83_X, camdata_summary$NAD83_Y,
       ...
       xlim = c(747430, 747550),
       ylim = c(4308910,4309030))
  text(labels = "Fox Squirrel", y = 4309025, x = 747443, cex = 1.6)
...
box()
  ...
  points(camdata_summary$NAD83_X, camdata_summary$NAD83_Y,
       ...
       xlim = c(747430, 747550),
       ylim = c(4308910,4309030))
  text(labels = "Northern Raccoon", y = 4309025, x = 747449, cex = 1.6)
...
points(camdata_summary$NAD83_X, camdata_summary$NAD83_Y,
       ...
       xlim = c(747430, 747550),
       ylim = c(4308910,4309030))
text(labels = "Black Bear", y = 4309025, x = 747442, cex = 1.6)
